...
;(function ( $, window, document, undefined ) {
    ...
    ComboTree.prototype.createSourceItemHTML = function (sourceItem) {
        ...
        itemHtml = '<LI class="li_class ComboTreeItem' + (isThereSubs?'Parent':'Chlid') + '"> ';
        ...
        if (this.options.isMultiple) {
                 if (isThereSubs){
                     ...
                     itemHtml += '<span data-id="' + sourceItem.id + '" class="comboTreeItemTitle">' + '<input class="input_checkbox" type="checkbox">' + sourceItem.title + '</span>';
                 }
